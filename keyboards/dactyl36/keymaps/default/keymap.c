...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        LGUI_T(KC_F11),    LALT(KC_HOME),    LSFT_T(KC_PAGE_UP),    LCTL_T(KC_PAGE_DOWN),    KC_END,                               KC_LEFT,    RCTL_T(KC_DOWN),    RSFT_T(KC_UP),   RALT_T(KC_RGHT),  RGUI_T(KC_F12),
        XXXXXXX,           XXXXXXX,          XXXXXXX,               XXXXXXX,                 XXXXXXX,                              XXXXXXX,    XXXXXXX,            XXXXXXX,         XXXXXXX,          XXXXXXX,
                                             XXXXXXX,               XXXXXXX,                 XXXXXXX,                              XXXXXXX,    XXXXXXX,            XXXXXXX
    ),
    [2] = LAYOUT(
        KC_EXLM,    KC_AT,      KC_HASH,    KC_DLR,     KC_PERC,    KC_CIRC,    KC_AMPR,    KC_ASTR,    KC_LPRN,    KC_RPRN,
        LGUI_T(KC_1),    LALT(KC_2),    LSFT_T(KC_3),    LCTL_T(KC_4),    KC_5,                               KC_6,    RCTL_T(KC_7),    RSFT_T(KC_8),   RALT_T(KC_9),  RGUI_T(KC_0),
